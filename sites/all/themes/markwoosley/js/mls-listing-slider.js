(function($) {
	...
	function init()
	{
		...
		$(".view-mls-listing-images .views-row").click(stop);
		max = rows().length;
		
		if(max < 2)
		{
			$(".view-mls-listing-images").css('display','none');
		}
	...
	function createIndicators()
	{
		...
		$(".view-mls-listing-images").append($ul);
	}
	...
	function container()
	{
		return $(".view-mls-listing-images .view-content");
	}
	function rows()
	{
	...
	function indicators()
	{
		return $(".view-mls-listing-images .indicators li");
	}
